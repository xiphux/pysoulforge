...
class dieroller(wx.Frame):
	...
	rngbox.Add(wx.StaticText(pan,-1,_("Pseudo-random number generator:")),0)
	self.rngctl = wx.Choice(pan,DIEROLLER_RNG,wx.DefaultPosition,wx.DefaultSize,headerdata.SF_DIEROLLER_RNGSTRINGS)
	...
	self.diffctl = wx.SpinCtrl(pan,DIEROLLER_DIFF,u"",wx.DefaultPosition,wx.DefaultSize,0,1,self.dicepool.faces,6)
	...
	self.resultbox = wx.TextCtrl(pan,-1,u"",wx.DefaultPosition,wx.DefaultSize,wx.TE_MULTILINE|wx.TE_READONLY)
	...
	self.successlabel = wx.StaticText(pan,-1, "0/" + str(self.dicepool.pool))
	...
	self.failurelabel = wx.StaticText(pan,-1,"0/" + str(self.dicepool.pool))
	...
	self.botchlabel = wx.StaticText(pan,-1,"0/" + str(self.dicepool.pool))
